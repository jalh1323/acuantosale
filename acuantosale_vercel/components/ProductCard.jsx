...
const STORE = {
  ...
  gama:      { label: 'GMA', dotColor: 'bg-gama-red',        textColor: 'text-gama-red',        priceColor: 'text-gama-red'        },
  luvebras:   { label: 'LVB', dotColor: 'bg-luvebras-green',   textColor: 'text-luvebras-green',   priceColor: 'text-luvebras-green'   },
}

export default function ProductCard({ product, bcvRate }) {
  const { name, brand, imageUrl, priceBs: rawPriceBs, fullPriceBs: rawFullPriceBs, priceUsd, fullPriceUsd, discountLabel, requiresPrescription, store } = product
